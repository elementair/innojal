...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-01-2018 a las 16:33:45
...
(1, 'Fresas', './views/fondo_index/archivos/Fresas_783869.jpg', 1, ''),
(2, 'Fresas2', './views/fondo_index/archivos/Fresas2_761283.jpg', 1, ''),
(3, 'Fresas3', './views/fondo_index/archivos/fwfq343_398087.jpg', 1, 'Fresas3'),
(4, 'Fresas4', './views/fondo_index/archivos/Fresas4_222899.jpg', 1, 'fresas4'),
(5, 'Fresas5', './views/fondo_index/archivos/Fresas5_265223.jpg', 1, 'Fresas5'),
(6, 'Fresas6', './views/fondo_index/archivos/Fresas6_870934.jpg', 1, 'Fresas6');
...
(2, 'Este texto es de muestra. Aquí se puede redactar a modo de prosa una muy breve descripción del producto si el cliente lo ve necesario.', '<table>\r\n    <tr>\r\n        <th>Calcio (Ca)</th>\r\n              <td>14.0%</td>\r\n      </tr>\r\n\r\n      <tr>\r\n          <th>Nitrógeno (N)</th>\r\n           <td>14.0%</td>\r\n      </tr>\r\n\r\n      <tr>\r\n           <th>Boro (B)</th>\r\n           <td>5000 ppm</td>\r\n      </tr>\r\n\r\n      <tr>\r\n           <th>Agentes quelantes</th>\r\n           <td>5.0%</td>\r\n      </tr>\r\n\r\n      <tr>\r\n            <th>Extractos Naturales</th>\r\n            <td>0.5%</td>\r\n       </tr>\r\n\r\n       <tr>\r\n             <th>Diluyentes y acondicionadores no más de</th>\r\n             <td>66.0%</td>\r\n        </tr>\r\n</table>', 1, 2, './views/producto/archivos/Anual_Reygrass_310695.png', '', 'Anual Reygrass'),
(3, 'Este texto es de muestra. Aquí se puede redactar a modo de prosa una muy breve descripción del producto si el cliente lo ve necesario', '', 1, 3, './views/producto/archivos/Austar_395941.png', '', 'Austar'),
(4, 'Este texto es de muestra. Aquí se puede redactar a modo de prosa una muy breve descripción del producto si el cliente lo ve necesario', '', 1, 4, './views/producto/archivos/Bactiva 2_190909.png', '', 'Bactiva 2'),
(5, 'Este texto es de muestra. Aquí se puede redactar a modo de prosa una muy breve descripción del producto si el cliente lo ve necesario', '', 1, 2, './views/producto/archivos/BC Mix Seeds_113214.png', '', 'BC Mix Seeds'),
(6, 'Este texto es de muestra. Aquí se puede redactar a modo de prosa una muy breve descripción del producto si el cliente lo ve necesario', '', 1, 5, './views/producto/archivos/Biosan_791338.png', '', 'Biosan'),
(7, 'Este texto es de muestra. Aquí se puede redactar a modo de prosa una muy breve descripción del producto si el cliente lo ve necesario', '', 1, 6, './views/producto/archivos/Eco Film_427983.png', '', 'Eco Film'),
(8, 'Este texto es de muestra. Aquí se puede redactar a modo de prosa una muy breve descripción del producto si el cliente lo ve necesario', '', 1, 5, './views/producto/archivos/Endospor_218456.png', '', 'Endospor'),
(9, 'Este texto es de muestra. Aquí se puede redactar a modo de prosa una muy breve descripción del producto si el cliente lo ve necesario', '', 1, 2, './views/producto/archivos/Endospor Granulado_883415.png', '', 'Endospor Granulado'),
(10, 'Este texto es de muestra. Aquí se puede redactar a modo de prosa una muy breve descripción del producto si el cliente lo ve necesario', '', 1, 3, './views/producto/archivos/Folicab_787529.png', '', 'Folicab'),
(11, 'Este texto es de muestra. Aquí se puede redactar a modo de prosa una muy breve descripción del producto si el cliente lo ve necesario', '', 1, 5, './views/producto/archivos/Fosfonat_813534.png', '', 'Fosfonat');
